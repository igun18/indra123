...
class Selfer_Mailchimp_Newsletter_Widget extends Widget_Base {

	public function get_name() {
		return 'slefer-mailchimp-newsletter';
	}

	public function get_title() {
		return esc_html__( 'Mailchimp Newsletter', 'selfer-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'mailchimp_id',
			[
				'label' => esc_html__( 'Paste ShortCode', 'selfer-core' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( '978', 'selfer-core' ),
				'description' => esc_html__( 'For show ID <a href="admin.php?page=mailchimp-for-wp-forms" target="_blank"> Click here </a>', 'selfer-core' ),
				'label_block' => true,
				'separator'   => 'before',
			]
		);
		...
		$this->start_controls_section(
			'section_style_input',
			[
				'label' => esc_html__( 'Input', 'selfer-core' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Placeholder Color', 'selfer-core' ),
		...
		$this->add_control(
			'input_border_show',
			[
				'label'        => esc_html__( 'Border Style', 'selfer-core' ),
		...
		$this->add_control(
			'fullwidth_input',
			[
				'label'     => esc_html__( 'Fullwidth Input', 'selfer-core' ),
				'type'      => Controls_Manager::SWITCHER,
				'selectors' => [
		...
		$this->start_controls_section(
			'section_style_label',
			[
				'label' => esc_html__( 'Label', 'selfer-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'label_position_top',
			[
				'label'     => esc_html__( 'Label Position Top', 'selfer-core' ),
				'type'      => Controls_Manager::SWITCHER,
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Typography', 'selfer-core' ),
		...
		$this->add_control(
			'fullwidth_button',
			[
				'label'     => esc_html__( 'Fullwidth Button', 'selfer-core' ),
				'type'      => Controls_Manager::SWITCHER,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Additional Option', 'selfer-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
...
Plugin::instance()->widgets_manager->register_widget_type( new Selfer_Mailchimp_Newsletter_Widget() );
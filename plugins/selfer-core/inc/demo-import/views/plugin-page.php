...
<div class="ocdi  wrap  about-wrap">
	...
	<?php ob_start(); ?>
		<h2 class="ocdi__title  dashicons-before  dashicons-upload"><?php esc_html_e( 'Demo Import', 'pt-ocdi' ); ?></h2>
	<?php
	...
	<div class="ocdi__intro-text">
		...
		<ul>
			...
			<li><?php esc_html_e( 'Posts, pages, images, widgets, menus and theme settings/customizer option will get imported.', 'pt-ocdi' ); ?></li>
			<li><?php esc_html_e( 'Please click on the Import button only once and wait, sometimes it can take a couple of minutes. Depended on your Internet Speed/Server Max Execution Time.', 'pt-ocdi' ); ?></li>
		</ul>

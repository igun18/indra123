...
/**
 * Class Selfer_Customize_Alpha_Color_Control
 */
class Selfer_Customize_Alpha_Color_Control extends WP_Customize_Control {
	/**
	...
	public function enqueue() {
		wp_enqueue_script( 'selfer-alpha-color-picker', get_theme_file_uri( '/customizer/customizer-alpha-color-picker/js/alpha-color-picker.js' ), array( 'jquery', 'wp-color-picker' ),TL_ALLO_VERSION, true	);
		wp_enqueue_style( 'selfer-alpha-color-picker', get_theme_file_uri( '/customizer/customizer-alpha-color-picker/css/alpha-color-picker.css' ), array( 'wp-color-picker' ),
			TL_ALLO_VERSION	);
	}
	/**
	 * Render the control.

 ...
 * @since 1.0
 */
function selferGetCss( arraySizes, settings, to ) {
    'use strict';
     var data, desktopVal,
 ...
 */
function selferSetCss( settings, to ){
    'use strict';
    var result     = '';
 ...
 */
wp.customize(
    'selfer_options[body_font_size]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
                ...
                selferGetCss( arraySizes, settings, to );
            }
        );
    }
);
wp.customize(
    'selfer_options[site_title_font_size]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'selfer_options[menu_font_size]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'selfer_options[post_blockquote_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'selfer_options[post_title_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'selfer_options[heading_one_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'selfer_options[heading_two_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'selfer_options[heading_three_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'selfer_options[heading_four_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'selfer_options[heading_five_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'selfer_options[heading_six_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'selfer_options[body_font_color]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
...
wp.customize(
    'selfer_options[heading_font_color]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
...
wp.customize(
    'selfer_options[site_title_color]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
...
wp.customize(
    'selfer_options[description_title_color]', function (value) {
        'use strict';
        value.bind(
            function( to ) {

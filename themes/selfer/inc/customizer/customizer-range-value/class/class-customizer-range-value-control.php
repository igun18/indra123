 ...
 * @access public
 */
class Selfer_Customizer_Range_Value_Control extends WP_Customize_Control {
	...
	/**
	 * Selfer_Customizer_Range_Value_Control constructor.
	 *
 ...
 * @since 1.0
 */
function selfer_sanitize_range_value( $input ) {
	if ( selferis_json( $input ) ) {
